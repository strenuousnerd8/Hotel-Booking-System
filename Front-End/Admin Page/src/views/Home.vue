...
<script>
import Hotels from "../components/HotelsComp.vue";
import Hotel from "../components/HotelComp.vue";
import UpdateHotel from "../components/HotelUpComp.vue";
import HotelSearch from "../components/HotelSearchComp.vue";
import HotelCancel from "../components/HotelCanComp.vue";

const routes = {
  "/": Hotels,
  "/addhotel": Hotel,
  "/updhotel": UpdateHotel,
